...
### SkyDome
To simulate the sky I used object sphere. To achieve the shaded effect of the sky I made some personal shaders inserted and recalled inside the [index.html](https://github.com/cerullosalvatore/RobotGL/blob/master/index.html) file.
...
* External element: it has the same shape as the crystal but a little wider and will have the task of emulating light reflections. In order to achieve this effect, I created some personal shaders contained in file  [index.html](https://github.com/cerullosalvatore/RobotGL/blob/master/index.html).
...
Crystal removal involves an animation implemented in function **animationRemotionCrystal()** in the file [collision.js](https://github.com/cerullosalvatore/RobotGL/blob/master/js/collision.js).

## Top Bar
A key element to support the player during the game is the top bar. This is written in html in the x file. The style is implemented in the bar.css file.
